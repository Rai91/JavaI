...
public class GameBattleship {
    ...
    public static boolean hit(int[] shoot, int[][] ships) {
        for(int ship = 0; ship < ships.length; ++ship) {
            if(shoot[0] == ships[ship][0] && shoot[1] == ships[ship][1]) {
                System.out.printf("You hit a ship located in (%d,%d)\n", new Object[]{Integer.valueOf(shoot[0] + 1), Integer.valueOf(shoot[1] + 1)});
                return true;
            }
        }
    ...
    public static void hint(int[] shoot, int[][] ships, int attempt) {
        ...
        System.out.printf("\nHint %d: \nRow %d -> %d ships\nColumn %d -> %d ships\n", new Object[]{Integer.valueOf(attempt), Integer.valueOf(shoot[0] + 1), Integer.valueOf(row), Integer.valueOf(shoot[1] + 1), Integer.valueOf(column)});
    }
